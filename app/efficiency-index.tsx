...
const miners: Miner[] = [
  ...
  { maker:"FutureBit", model:"Apollo III — 15.22 TH/s profile", hashrate:15.22, watts:259, jth:17.02, cooling:"Air", year:2026, segment:"Home", mode:"15.22 TH/s profile", note:"SerpentX Tech test result · published Aug 20, 2026", confidence:"Independent test", source:"https://youtu.be/HLWiE5i1kwc?si=995ujHKEtJvFQFub", sourceName:"SerpentX Tech", video:{url:"https://youtu.be/HLWiE5i1kwc?si=995ujHKEtJvFQFub",title:"FutureBit Apollo III — hands-on test and operating modes"} },
